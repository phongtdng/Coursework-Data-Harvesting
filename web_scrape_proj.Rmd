...
remDr$client$navigate(prep_browser(merc_1))
...
merc |> 
  xml_find_all("//div[@data-test='product-cell']")

merc |> 
  xml_find_all("//*//div[@data-test='product-cell']") 
  
merc |> 
  xml_find_all("//*/div[@class='product_cell-info']/h4[@class='subhead1-r product-cell_description-name]") 
  
merc |> 
  xml_find_all("//div//*[@class='product_cell-info']") 
