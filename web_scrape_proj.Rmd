...
remDr <- rsDriver(port = 4463L, browser = "firefox",  verbose=F, chromever = NULL)
...
final$gender_name <-str_extract_all(final$name, regex(gender_or))

# Convert 'character(0)' to 'Non-Male'
final$gender_name[final$gender_name == "character(0)"] <- "Non-Male"
...
final$gender <- case_when(final$gender_name %in% male ~ "Male",
                          final$gender_name %in% female ~ "Female",
                          final$gender_name == "Non-Male"~ "Non-Male")
