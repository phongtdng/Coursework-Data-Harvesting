...
remDr <- rsDriver(port = 4458L, browser = "firefox",  verbose=F, chromever = NULL)
...
total_url <-rbind(url_1.1, url_1.2, url_1.3, url_1.4, url_2.1, url_2.2, url_2.3, url_2.4, url_2.5, url_2.6, url_2.7, url_2.8, url_2.9, url_2.10, url_2.11)

total_url_list <-list(url_1.1, url_1.2, url_1.3, url_1.4, url_2.1, url_2.2, url_2.3, url_2.4, url_2.5, url_2.6, url_2.7, url_2.8, url_2.9, url_2.10, url_2.11)

total_url_ul <-unlist(total_url_list)
...
cat_grabber <- function(total_url_ul){
  
Sys.sleep(2)

driver$navigate(total_url_ul)
...
at_clean<-cat_info|> 
  str_replace_all("\\€ |/|\\.", "") |> 
  strsplit("\\s(?=\\d+\\s*ud)|\\.*ud|\\s(?=\\d+\\s*ml)|ml", perl = TRUE) 
...
cat_grabber(total_url_ul)


final <- map_dfr(total_url_ul, cat_grabber) 
