...
The method for obtaining the t-test results is repeated with minor adjustments to obtain the t-test results for the sub-categories. The data is filtered based on the subcategory
